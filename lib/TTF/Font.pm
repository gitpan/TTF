...
TTF::Font - Memory representation of a font
...
defaults to L<TTF::Table>. The current tables which are supported are:

    table       TTF::Table      - for unknown tables
    LTSH        TTF::LTSH
    OS/2        TTF::OS_2
    PCLT        TTF::PCLT
    cmap        TTF::Cmap
    cvt         TTF::Cvt_
    fpgm        TTF::Fpgm
    glyf        TTF::Glyf       - see also TTF::Glyph
    hdmx        TTF::Hdmx
    head        TTF::Head
    hhea        TTF::Hhea
    hmtx        TTF::Hmtx
...
=head2 TTF::Font->AddTable($tablename, $class)
...
needed if using TTF::Font::read before using a table.
...
sub out
{
    ...
    ($numTables, $sRange, $eSel, $shift) = TTF::Utils::TTF_bininfo($#tlist + 1, 16);
...
The current TTF::Font::out method does not support the writing of TrueType
Collections.
